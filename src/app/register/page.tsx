                ...
                <div className="card dark:bg-primary bg-base-100 w-full md:w-96 max-w-sm shrink-0 shadow-2xl">
                    <form className="card-body ">
                        ...
                        <div className="form-control mt-3">
                            <button className="'btn btn-primary bg-secondary border-none hover:bg-blue-500 rounded-xl py-3">Register</button>
                        </div>
                        <div className='mt-3 text-center'>
                            <span>Already have account? please <Link href={'/login'} className='text-secondary font-semibold'>Login</Link></span>
                        </div>
                    </form>
                </div>
            </div>
